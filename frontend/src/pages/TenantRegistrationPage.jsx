        ...
        <div className="grid grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)] gap-10">
          ...
          <section className="rounded-3xl bg-white border border-gray-100 shadow-[0_10px_28px_rgba(15,23,42,0.08)] p-5 sm:p-7">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <h3 className="text-4xl font-extrabold text-emerald-800 tracking-tight">
                Tenants Information
              </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-6 h-[50px] rounded-xl border border-gray-200 px-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="h-[50px] w-12 rounded-xl border border-gray-200 bg-white text-gray-700 disabled:opacity-50"
                    >
                      −
                    </button>
                    <input
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full md:w-[300px] h-12 rounded-full bg-emerald-700 hover:bg-emerald-800 text-white font-semibold text-lg transition disabled:opacity-50"
                >
