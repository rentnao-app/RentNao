...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5faf5] text-gray-800">
      <header className="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-[#dceadf]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              type="button"
              className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[#dceadf] bg-white text-gray-700 shadow-sm hover:bg-[#f4faf4] hover:border-[#c5ddc9] transition"
        ...
        <div className="md:hidden fixed inset-0 z-[100] flex justify-end" role="presentation">
          ...
          >
            ...
            <nav className="flex-1 overflow-y-auto overscroll-contain px-3 py-4 flex flex-col gap-1" aria-label="Mobile">
              ...
              {showFindProperty && (
                <Link to="/listings" className="text-gray-700">
                  Find Property
                </Link>
              )}
              {showListProperty && (
                <Link to="/owner-dashboard/create-listing" className="text-gray-700">
                  List Your Property
                </Link>
              )}
              {loggedIn ? (
      ...
      <section className="relative overflow-hidden bg-[#eef7ef] border-b border-[#ddeee1]">
        <div className="relative w-full">
          <img
            src={hero}
            alt="Happy couple with rented home"
            className="w-full h-[220px] sm:h-[300px] lg:h-[400px] object-cover brightness-110 saturate-110"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-white/35 via-white/20 to-transparent" />
          <div className="absolute inset-0 z-10 flex items-center">
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
              <h1
                className="text-3xl sm:text-5xl font-bold leading-tight text-[#1e4732] max-w-2xl"
              ...
              <p
                className="mt-4 text-base sm:text-lg text-[#38684a] max-w-2xl"
                style={{ fontFamily: HERO_TEXT_FONT }}
              >
              ...
              <form
                ...
                className="mt-6 w-full max-w-2xl bg-white/95 border border-[#d9e9dd] shadow-md rounded-2xl p-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2"
              >
                <select
                ...
                <button
                  type="submit"
                  className="bg-[#2f8444] hover:bg-[#256c38] text-white font-semibold rounded-xl px-4 py-3 transition"
                >
                  Search
                </button>
              </form>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-3 sm:-mt-5 relative z-10">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
        <div
          className={`bg-[#2f8444] text-white rounded-xl py-3 px-4 sm:px-5 flex flex-col sm:flex-row items-center gap-2 ${
            loggedIn ? 'justify-center' : 'justify-between'
          }`}
        >
          <p className="font-semibold text-base sm:text-lg text-center sm:text-left leading-tight">
          ...
          {!loggedIn && (
            <button
              ...
              className="bg-[#e6f4e6] text-[#2f8444] font-semibold px-4 py-1.5 rounded-lg hover:bg-white transition text-sm"
            >
              Get Started
            </button>
          )}
