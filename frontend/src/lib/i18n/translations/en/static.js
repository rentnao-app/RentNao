export default {
  ...
  faq: {
    ...
    empty: 'No questions match your search. Try another keyword or category.',
    resultsCount: '{count} questions',
    ctaTitle: 'Still need help?',
    ctaBody: 'Learn more about RentNao or reach us from the Contact page.',
    ctaButton: 'About RentNao',
    back: 'Back',
    nav: {
      about: 'About',
      terms: 'Terms',
    ...
    items: [
      ...
      },
      {
        id: 'list-property',
        category: 'owners',
        q: 'How do I list my property on Rent Nao?',
        intro: 'Listing your property is simple and free.',
        bullets: [
          'Create an account or log in as an owner.',
          'Open List Property from your dashboard.',
          'Enter property details (location, rent, size, type, and availability).',
          'Upload photos and submit your listing.',
          'After approval, your property goes live and is visible to tenants.',
        ],
        note: 'You only pay if you choose optional premium services, such as a featured listing.',
      },
      {
        id: 'property-types',
        category: 'owners',
        q: 'What types of properties can be listed?',
        intro: 'You can list residential and commercial spaces that are legally available for rent, including:',
        bullets: [
          'Apartments and houses',
          'Bachelor flats and family units',
      ...
      },
      {
        id: 'register',
        category: 'tenants',
        q: 'How do I register on Rent Nao?',
        intro: 'To create an account:',
        bullets: [
          'Click Sign Up',
          'Enter your name, phone number, and password',
          'Choose tenant or owner',
          'Complete your profile and verification when prompted',
        ],
        outro: 'Use a real phone number so owners and tenants can communicate smoothly.',
      },
      {
        id: 'search-filter',
        category: 'tenants',
        q: 'How can I search and filter properties?',
        intro: 'Tenants can search and filter listings by:',
        bullets: [
          'Location / area',
          'Budget range',
          'Property type',
        ...
        outro: 'Apply filters from Browse, then open a listing to see details and contact the owner.',
      },
      {
        id: 'chat',
        category: 'tenants',
        q: 'How does in-app chat work?',
        intro: 'After you unlock or connect on a listing, you can message the other party in RentNao chat.',
        bullets: [
          'Open Messages from the header or dashboard',
          'Keep the conversation on-platform for a safer record',
        ],
        note: 'Chat is for rental coordination. It does not replace a signed agreement between both sides.',
      },
      {
        id: 'wallet',
        category: 'wallet',
        q: 'How does the RentNao wallet work?',
        intro: 'The in-app wallet holds BDT for platform fees such as listing unlocks and other paid actions.',
        bullets: [
          'Top up from the Wallet page',
          'Pay fees without leaving RentNao',
      ...
      },
      {
        ...
        intro: 'Open Wallet, start a top-up, and follow the payment instructions shown on screen.',
        outro: 'Admin may need to confirm some top-ups before the balance appears.',
      },
      {
        id: 'kyc-why',
        category: 'kyc',
        q: 'Why do I need identity verification?',
        intro: 'KYC helps keep the marketplace safer for both tenants and owners.',
        bullets: [
          'Submit valid ID documents from the verification flow',
          'Wait for review before some features fully unlock',
        ],
        note: 'Verification is not a guarantee of character or listing quality. Always use your own judgment.',
      },
      {
        id: 'kyc-time',
        category: 'kyc',
        q: 'How long does KYC review take?',
        intro: 'Most submissions are reviewed within one to two business days.',
        outro: 'You will see the status on your verification or dashboard page. Incomplete documents can delay approval.',
      },
      {
        id: 'agreements',
        category: 'agreements',
        q: 'Does Rent Nao provide a rent agreement?',
        intro: 'RentNao can help generate a rent-deed style document for eligible deals.',
        bullets: [
          'Both sides still review and confirm the terms',
          'The platform is not a party to your rental contract unless we say so in writing',
        ],
      },
    ],
  },
