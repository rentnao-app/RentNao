...
export const createPropertySchema = z.object({
  ...
  hasCcCamera: z.boolean().optional().default(false),
  hasGas: z.boolean().optional().default(false),
  nearbyMetroStation: z.boolean().optional().default(false),
  nearbyPublicTransports: z.boolean().optional().default(false),
  nearbyMosque: z.boolean().optional().default(false),
  nearbySchool: z.boolean().optional().default(false),
  nearbyGym: z.boolean().optional().default(false),
  nearbyTurf: z.boolean().optional().default(false),
  nearbyPlayingField: z.boolean().optional().default(false),
  nearbyBazar: z.boolean().optional().default(false),
  nearbySupershop: z.boolean().optional().default(false),
...
export const propertyResponseSchema = z.object({
  ...
  hasCcCamera: z.boolean().nullable().optional(),
  hasGas: z.boolean().nullable().optional(),
  nearbyMetroStation: z.boolean().nullable().optional(),
  nearbyPublicTransports: z.boolean().nullable().optional(),
  nearbyMosque: z.boolean().nullable().optional(),
  nearbySchool: z.boolean().nullable().optional(),
  nearbyGym: z.boolean().nullable().optional(),
  nearbyTurf: z.boolean().nullable().optional(),
  nearbyPlayingField: z.boolean().nullable().optional(),
  nearbyBazar: z.boolean().nullable().optional(),
  nearbySupershop: z.boolean().nullable().optional(),
...
export const publicListingDetailSchema = publicListingSummarySchema.extend({
  ...
  hasCcCamera: z.boolean().optional(),
  hasGas: z.boolean().optional(),
  nearbyMetroStation: z.boolean().optional(),
  nearbyPublicTransports: z.boolean().optional(),
  nearbyMosque: z.boolean().optional(),
  nearbySchool: z.boolean().optional(),
  nearbyGym: z.boolean().optional(),
  nearbyTurf: z.boolean().optional(),
  nearbyPlayingField: z.boolean().optional(),
  nearbyBazar: z.boolean().optional(),
  nearbySupershop: z.boolean().optional(),
  floorNo: z.number().nullable(),
  propertyAddressBn: z.string().nullable().optional(),
  floorNoBn: z.string().nullable().optional(),
  flatNoBn: z.string().nullable().optional(),
